...
{
    public class FourthMachine<T> : MachineBase<T> where T : ProductBase
    {
        ...
        public override double Delay { get; set; } = 10;
        ...
        public override int CrashRatePerProduct { get; set; } = 90;
